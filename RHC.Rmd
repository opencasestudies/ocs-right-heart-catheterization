...
Data visuzlization is adjective considering it enables us to get a grasp on the difference between 'No RHC' and 'RHC' group faster. We would like to use `ggplot2` to create some plots.
