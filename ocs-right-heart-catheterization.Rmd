...
steps which, with a large enough sample size, approaches
...
used to create a `surv object`, which is the response 
varable in our survival analysis. Also, we need to 
pay attention to the datatype of `death`.
