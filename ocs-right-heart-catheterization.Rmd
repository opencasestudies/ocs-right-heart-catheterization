...
The reason why we get 'NA' here is: median survival is 
the time at which the survival rates equals 0.5. 
In our case, since minimum value is over 0.6, 
it never gets there, thus the output shows 'NA'.
